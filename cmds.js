    ...
    if (typeof id === "undefined") {
        ...
        try {
            ...
            rl.question(colorize(quiz.question+'? ', 'red'), resp => {
                ...
                let answer = resp.toLowerCase().trim();

                if(answer === quiz.answer.toLowerCase().trim()){
                    biglog(colorize('Correcto'),'green');
                    rl.prompt();
                } else {
                    biglog(colorize('Incorrecto'),'red');
                    rl.prompt();
                }
            });
        } catch (error) {
...
exports.creditsCmd = rl => {
      ...
      log('Autor de la práctica:', 'magenta');
      log('Julián Catalina Gómez', 'yellow');
      rl.prompt();
